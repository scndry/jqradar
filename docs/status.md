...
**있는 것**: `prd.md` v3.8.6(D1–D150). `contract/` 케이스 **88종** — percentile 6 · **schema 51** · cpd 5 · **history 15** · graph 8 · **reproducibility 3**. `schemas/` 7종. Gradle 골격과 자체 ArchUnit 규칙 넷 + 반례(11 tests). CI **5잡**. `docs/preregistration/p1a.md`, `docs/battery.md`(실측).
...
**남은 것은 열린 발견이다.** 정확한 수는 O14가 정해질 때 확정된다 — 지금은 후보 목록이고, 두 패널의 기록이 정본이다([`review/records/`](review/records/)). 패널이 이미 두 번 돌았고 **둘 다 "통과시키지 않음"**이다.
