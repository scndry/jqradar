...
**있는 것**: `prd.md` v3.8.6(D1–D150). `contract/` 케이스 **90종** — percentile 6 · **schema 53** · cpd 5 · **history 15** · graph 8 · **reproducibility 3**. `schemas/` 7종. Gradle 골격과 자체 ArchUnit 규칙 넷 + 반례(11 tests). CI **5잡**. `docs/preregistration/p1a.md`, `docs/battery.md`(실측).
