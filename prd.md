# 📡 jQRadar (Java Quality Radar) — PRD v3.9.1
...
{ "schema": "jqradar/people/1", "analysis_input_id": "sha256:…",      // 어느 분석의 것인가 — report와 같은 id
  ...
  "files": [
    { "path": "order/OrderService.java",
      ...
      "authors": null } ],                                            // individual일 때만: [{author_id, commits}] — 조직이 켠 것이고 개인 순위 표면은 만들지 않는다(§11)
